...
> 🇺🇸 English | [🇹🇼 繁體中文](#aprnes---c-nes-模擬器) | Last updated: 2026-03-15 11:50
...
| Script | Purpose |
|--------|---------|
| `build.bat` / `build.ps1` | Build AprNes (.NET Framework 4.8.1) |
...
*   **Language**: C#
*   **Framework**: .NET Framework 4.8.1 (Windows Forms)
*   **Compiler**: MSBuild (VS2022 toolchain)
...
> [🇺🇸 English](#aprnes---c-nes-emulator) | 🇹🇼 繁體中文 | 最後編修：2026-03-15 11:50
...
*   **語言**: C#
*   **框架**: .NET Framework 4.8.1（Windows Forms）
*   **編譯器**: MSBuild（VS2022 工具鏈）
*   **平台**: Windows x64
