...
*   **`AprNes/NesCore/`** — Emulator core (platform-independent simulation layer).
    ...
    *   `Mapper/` — Cartridge mapper implementations (24 mappers: NROM/MMC1/UxROM/CNROM/MMC3/MMC5/AxROM/MMC2/MMC4/ColorDreams/VRC4/VRC2a/VRC2b/G-101/TC0190/Nina-1/RAMBO-1/H-3001/GxROM/Sunsoft#4/FME-7/Camerica/Irem78/Namco108).
...
*   **`AprNes/NesCore/`** — 模擬器核心邏輯（純模擬層，不依賴任何系統/UI 函式庫）。
    ...
    *   `Mapper/` — 各類遊戲卡匣控制晶片實作（24 種 Mapper：NROM/MMC1/UxROM/CNROM/MMC3/MMC5/AxROM/MMC2/MMC4/ColorDreams/VRC4/VRC2a/VRC2b/G-101/TC0190/Nina-1/RAMBO-1/H-3001/GxROM/Sunsoft#4/FME-7/Camerica/Irem78/Namco108）。
