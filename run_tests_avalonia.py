...
Usage:
    python run_tests_avalonia.py          # 8 threads (default)
    python run_tests_avalonia.py -j 4     # 4 threads
    python run_tests_avalonia.py -j 1     # sequential
"""
import subprocess, os, sys, time, argparse
from concurrent.futures import ThreadPoolExecutor, as_completed

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
EXE = os.path.join(SCRIPT_DIR, "AprNesAvalonia", "bin", "Debug", "net10.0", "AprNesAvalonia.exe")
...
def main():
    parser = argparse.ArgumentParser(description="Run NES test ROMs (AprNesAvalonia)")
