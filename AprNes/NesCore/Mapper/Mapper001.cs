...
namespace AprNes
{
    unsafe public partial class NesCore
    {
        ...
        public static int PRG_Bankmode;
        public static int CHR_Bankmode;
        public static int Mirroring_type;
        ...
        //MMC1 http://wiki.nesdev.com/w/index.php/MMC1
        unsafe public class Mapper001 : CMapper
        {
            public Mapper001(byte* prgROM, byte* chrROM) : base(prgROM, chrROM) { }
