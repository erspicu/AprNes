    ...
    static class MapperRegistry
    {
        ...
        public static string GetName(int id)
        {
            switch (id)
            {
                ...
                case 191: return "MMC3 + 2KB CHR-RAM (bank 0x80-0xFF wrap)";
                case 192: return "MMC3 + 4KB CHR-RAM (bank 8-0xB)";
                case 194: return "MMC3 + 2KB CHR-RAM (bank 0-1)";
                case 12:  return "DBDROM (MMC3 + CHR high-bit)";
        ...
        public static IMapper Create(int id, RomDbEntry db)
        {
            ...
            switch (id)
            {
                ...
                case 112: {
                    System.Console.WriteLine("Mapper112: Asder / Ntdec");
                    return new Mapper112();
                }
                case 177: {
                    System.Console.WriteLine("Mapper177: Henggedianzi");
                    return new Mapper177();
                }
                case 164: {
                ...
                case 191: {
                    System.Console.WriteLine("Mapper191: MMC3 + 2KB CHR-RAM (bank 0x80-0xFF wrap)");
                    return new Mapper191();
                }
                case 192: {
                    System.Console.WriteLine("Mapper192: MMC3 + 4KB CHR-RAM (bank 8-0xB)");
                    return new Mapper192();
                }
                case 194: {
                    System.Console.WriteLine("Mapper194: MMC3 + 2KB CHR-RAM (bank 0-1)");
                    return new Mapper194();
                }
                case 12: {
                    System.Console.WriteLine("Mapper012: DBDROM (MMC3 + CHR high-bit)");
                    return new Mapper012();
                }
                case 96: {
                    System.Console.WriteLine("Mapper096: Bandai Oeka Kids");
                    return new Mapper096();
                }
                case 163: {
                    System.Console.WriteLine("Mapper163: Nanjing");
