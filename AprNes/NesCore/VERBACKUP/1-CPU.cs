...
namespace AprNes
{
    ...
    /*0xF0*/ 2,5,2,8,4,4,6,6,2,4,2,7,4,4,7,7
        ...
        public byte GetFlag()//bit 5 fixed
        {
        ...
        private void cpu_step()
        {
            ...
            switch (opcode)
            {
                ...
                case 0xF0://BEQ
                    {
                       // cpu_cycles = 3; // !!!! need check
                        sbyte t1 = (sbyte)Mem_r(r_PC++);
                        ushort addr = (ushort)(r_PC + t1);

                        //addr = 9404
                        //if ( r_PC == 0x9401 )
                          //  MessageBox.Show( addr.ToString("x4"));
                ...
                case 0xAD://LDA abs
                    ...
                    test = (ushort)(Mem_r(r_PC++) | (Mem_r(r_PC++) << 8));
                    r_A = Mem_r(test);

                    if (r_PC == 0x93ff)
                    {
                       // MessageBox.Show("!!!!! "  + test.ToString("X4"));
                    }
