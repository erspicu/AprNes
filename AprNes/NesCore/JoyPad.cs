...
namespace AprNes
{
    ...
    {
        byte[] P1_joypad_status = new byte[] { 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40 };
        ...
        {
            if (P1_StrobeState < 8)
                P1_r = P1_joypad_status[P1_StrobeState];
            else if (P1_StrobeState >= 8 && P1_StrobeState < 19)
                P1_r = 0;
            else if (P1_StrobeState == 19)
                P1_r = 1;
            else
                P1_r = 0;
            P1_StrobeState++;
