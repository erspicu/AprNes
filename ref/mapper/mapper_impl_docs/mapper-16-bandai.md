...
- `$6008`: +---------------------+ | +------+ | | | | | | |
- `$8000`: +----------------------------------------------+ +---------------------+ +----------------------------------------------+
- `$6009`: +---------------------+ | || | | +| | | | | | +--- Mirroring/Page Select | | 0 - Horizontal mirroring | | 1 - Vertical mirroring |
- `$2400`: +----------------------------------------------+ +---------------------+ +----------------------------------------------+
- `$600A`: +---------------------+ | | | | | | | | | | +--- IRQ Control Register | | 0 - Disable IRQ's | | 1 - Enable IRQ's | +----------------------------------------------+ +---------------------+ +----------------------------------------------+
- `$600B`: +---------------------+ | +------+ | | | | | | | | +------- Low byte of IRQ counter | +----------------------------------------------+ +---------------------+ +----------------------------------------------+
- `$600C`: +---------------------+ | +------+ | | | | | | | | +------- High byte of IRQ counter | +----------------------------------------------+ +---------------------+ +----------------------------------------------+
- `$600D`: +---------------------+ | +------+ | | | | | | | | +------- EPROM I/O Port | | I am not sure how this works. | +----------------------------------------------+
