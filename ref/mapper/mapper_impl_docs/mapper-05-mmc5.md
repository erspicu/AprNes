...
- `$5103`: +-------+ | || | | ++ | | | | | +-- Sprite CHR bank size | | 0 - One 8K bank | | 1 - Two 4K banks | | 2 - Three 2K banks | | 3 - Four 1K banks | +--------------------------------------------+ +-------+ +-----------------------------------------------+
- `$5104`: +-------+ | || | | || | | || | | |+--- EXRAM background tile select | | | 0 - Normal tile support | | | 1 - Enable EXRAM for tiles | | | | | +---- EXRAM color select | | 0 - EXRAM color off | | 1 - Enable EXRAM color expansion | +-----------------------------------------------+ +-------+ +--------------------------------------------+
- `$5105`: +-------+ | |||||||| | | ++++++++ | | | | | | |
- `$2000`: | | | | |
- `$2400`: | | | |
- `$2800`: | | |
- `$2C00`: +--------------------------------------------+ +-------+ +----------------------------------------------+
- `$5114`: +-------+ | |+-----+ | | | | | | | | |
- `$8000`: | | | | +---------- PRG Bank Activation | | 0 = Bank contains all $FFs | | 1 = Bank contains 8K of ROM | | selected from bits 0-7 | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5115`: +-------+ | |+-----+ | | | | | | | | |
- `$A000`: | | | | +---------- PRG Bank Activation | | 0 = Bank contains all $FFs | | 1 = Bank contains 8K of ROM | | selected from bits 0-7 | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5116`: +-------+ | |+-----+ | | | | | | | | |
- `$C000`: | | | | +---------- PRG Bank Activation | | 0 = Bank contains all $FFs | | 1 = Bank contains 8K of ROM | | selected from bits 0-7 | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5120`: +-------+ | +------+ | | | | | | |
- `$0000`: | Only active if 1K switching is |
- `$5103`: | This CHR selection is used for | | drawing sprites only. | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5121`: +-------+ | +------+ | | | | | | | | +------- (If 1K switching is active |
- `$0400`: | (If 2K switching is active |
- `$0000`: | This CHR selection is used for | | drawing sprites only. | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5122`: +-------+ | +------+ | | | | | | |
- `$0800`: | Only active if 1K switching is |
- `$5123`: +-------+ | +------+ | | | | | | | | +------- (If 1K switching is active |
- `$0C00`: | (If 2K switching is active |
- `$0800`: | (If 4K switching is active |
- `$5124`: +-------+ | +------+ | | | | | | |
- `$1000`: | Only active if 1K switching is |
- `$5125`: +-------+ | +------+ | | | | | | | | +------- (If 1K switching is active |
- `$1400`: | (If 2K switching is active |
- `$1000`: | This CHR selection is used for | | drawing sprites only. | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5126`: +-------+ | +------+ | | | | | | |
- `$1800`: | Only active if 1K switching is |
- `$5127`: +-------+ | +------+ | | | | | | | | +------- (If 1K switching is active |
- `$1C00`: | (If 2K switching is active |
- `$1800`: | (If 4K switching is active |
- `$1000`: | (If 8K switching is active |
- `$5128`: +-------+ | +------+ | | | | | | |
- `$0000`: | This CHR selection is used only | | for drawing the nametables if | | EXRAM is not activated. | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$5129`: +-------+ | +------+ | | | | | | |
- `$0800`: | This CHR selection is used only | | for drawing the nametables if | | EXRAM is not activated. | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$512A`: +-------+ | +------+ | | | | | | |
- `$1000`: | This CHR selection is used only | | for drawing the nametables if | | EXRAM is not activated. | +----------------------------------------------+ +-------+ +----------------------------------------------+
- `$512B`: +-------+ | +------+ | | | | | | |
- `$1800`: | This CHR selection is used only | | for drawing the nametables if | | EXRAM is not activated. | +----------------------------------------------+
