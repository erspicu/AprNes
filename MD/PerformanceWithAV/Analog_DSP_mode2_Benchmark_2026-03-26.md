...
|:----------:|:------:|:------:|:-----------:|:-----:|:-----:|:------------:|:--------:|
| 2x | 512×420 | 215.0K | 116.66 | 116.20 | 116.16 | **116.18** | 1.93x |
| 4x | 1024×840 | 860.2K | 107.26 | 106.89 | 103.00 | **104.94** | 1.75x |
| 6x | 1536×1260 | 1935.4K | 85.06 | 85.01 | 84.86 | **84.94** | 1.41x |
| 8x | 2048×1680 | 3440.6K | 73.23 | 73.40 | 73.26 | **73.33** | 1.22x |

### 效能縮放分析

| 比較 | 基準 (2x) FPS | 目標 FPS | 像素比 | FPS 比 | 備註 |
|------|:------------:|:--------:|:------:|:------:|------|
| 2x → 2x | 116.18 | 116.18 | 1.0x | 1.00x | 基準 |
| 2x → 4x | 116.18 | 104.94 | 4.0x | 0.90x |  |
| 2x → 6x | 116.18 | 84.94 | 9.0x | 0.73x |  |
| 2x → 8x | 116.18 | 73.33 | 16.0x | 0.63x |  |
