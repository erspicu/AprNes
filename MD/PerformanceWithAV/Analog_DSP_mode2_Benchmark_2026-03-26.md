...
|:----------:|:------:|:------:|:-----------:|:-----:|:-----:|:------------:|:--------:|
| 2x | 512×420 | 215.0K | 116.75 | 114.54 | 116.53 | **115.53** | 1.92x |
| 4x | 1024×840 | 860.2K | 108.99 | 107.83 | 107.08 | **107.45** | 1.79x |
| 6x | 1536×1260 | 1935.4K | 85.69 | 85.55 | 85.48 | **85.52** | 1.42x |
| 8x | 2048×1680 | 3440.6K | 73.41 | 73.81 | 73.74 | **73.78** | 1.23x |

### 效能縮放分析

| 比較 | 基準 (2x) FPS | 目標 FPS | 像素比 | FPS 比 | 備註 |
|------|:------------:|:--------:|:------:|:------:|------|
| 2x → 2x | 115.53 | 115.53 | 1.0x | 1.00x | 基準 |
| 2x → 4x | 115.53 | 107.45 | 4.0x | 0.93x |  |
| 2x → 6x | 115.53 | 85.52 | 9.0x | 0.74x |  |
| 2x → 8x | 115.53 | 73.78 | 16.0x | 0.64x |  |
