...
|:----------:|:------:|:------:|:-----------:|:-----:|:-----:|:------------:|:--------:|
| 2x | 512×420 | 215.0K | 95.23 | 120.82 | 115.28 | **118.05** | 1.96x |
| 4x | 1024×840 | 860.2K | 112.04 | 110.15 | 107.82 | **108.98** | 1.81x |
| 6x | 1536×1260 | 1935.4K | 85.93 | 88.77 | 89.56 | **89.16** | 1.48x |
| 8x | 2048×1680 | 3440.6K | 73.95 | 74.52 | 76.94 | **75.73** | 1.26x |

### 效能縮放分析

| 比較 | 基準 (2x) FPS | 目標 FPS | 像素比 | FPS 比 | 備註 |
|------|:------------:|:--------:|:------:|:------:|------|
| 2x → 2x | 118.05 | 118.05 | 1.0x | 1.00x | 基準 |
| 2x → 4x | 118.05 | 108.98 | 4.0x | 0.92x |  |
| 2x → 6x | 118.05 | 89.16 | 9.0x | 0.76x |  |
| 2x → 8x | 118.05 | 75.73 | 16.0x | 0.64x |  |
