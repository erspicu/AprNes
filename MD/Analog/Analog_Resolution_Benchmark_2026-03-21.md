...
|:----------:|:------:|:------:|:-----------:|:-----:|:-----:|:------------:|:--------:|
| 2x | 512×420 | 215.0K | 92.15 | 93.52 | 93.93 | **93.72** | 1.56x |
| 4x | 1024×840 | 860.2K | 84.22 | 84.67 | 84.99 | **84.83** | 1.41x |
| 6x | 1536×1260 | 1935.4K | 64.28 | 63.95 | 64.12 | **64.03** | 1.07x |
| 8x | 2048×1680 | 3440.6K | 58.40 | 58.14 | 58.09 | **58.12** | 0.97x |

### 效能縮放分析

| 比較 | 基準 (2x) FPS | 目標 FPS | 像素比 | FPS 比 | 備註 |
|------|:------------:|:--------:|:------:|:------:|------|
| 2x → 2x | 93.72 | 93.72 | 1.0x | 1.00x | 基準 |
| 2x → 4x | 93.72 | 84.83 | 4.0x | 0.91x |  |
| 2x → 6x | 93.72 | 64.03 | 9.0x | 0.68x |  |
| 2x → 8x | 93.72 | 58.12 | 16.0x | 0.62x |  |
