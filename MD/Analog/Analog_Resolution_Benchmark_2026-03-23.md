...
|:----------:|:------:|:------:|:-----------:|:-----:|:-----:|:------------:|:--------:|
| 2x | 512×420 | 215.0K | 120.55 | 119.99 | 120.21 | **120.10** | 2.00x |
| 4x | 1024×840 | 860.2K | 112.07 | 111.58 | 109.64 | **110.61** | 1.84x |
| 6x | 1536×1260 | 1935.4K | 83.65 | 83.42 | 84.67 | **84.05** | 1.40x |
| 8x | 2048×1680 | 3440.6K | 82.47 | 81.73 | 81.85 | **81.79** | 1.36x |

### 效能縮放分析

| 比較 | 基準 (2x) FPS | 目標 FPS | 像素比 | FPS 比 | 備註 |
|------|:------------:|:--------:|:------:|:------:|------|
| 2x → 2x | 120.10 | 120.10 | 1.0x | 1.00x | 基準 |
| 2x → 4x | 120.10 | 110.61 | 4.0x | 0.92x |  |
| 2x → 6x | 120.10 | 84.05 | 9.0x | 0.70x |  |
| 2x → 8x | 120.10 | 81.79 | 16.0x | 0.68x |  |
