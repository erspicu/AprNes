...
chcp 65001 >nul 2>&1
title AprNesAvalonia Baseline Benchmark (1x / Pure Digital)
...
:: ============================================================
:: AprNesAvalonia Baseline Benchmark
...
set "TMPFILE=%TEMP%\aprnesava_bench_baseline.txt"
set JIT_SEC=20
set TEST_SEC=20
set COOL_SEC=30

echo ============================================================
echo   AprNesAvalonia Baseline Benchmark
echo   ROM: ny2011.nes
...
:: -- Results Summary --
echo ============================================================
echo   BASELINE BENCHMARK RESULTS (AprNesAvalonia / .NET 10)
echo ============================================================
echo.
echo   Configuration:
