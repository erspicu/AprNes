...
chcp 65001 >nul 2>&1
title AprNesAvalonia Full Pipeline Benchmark

:: ============================================================
:: AprNesAvalonia Full Pipeline Benchmark
:: Tests: NTSC + Audio Mode 2 (Modern Stereo)
::        + Analog + Ultra Analog + CRT
:: Resolutions: 2x, 4x, 6x, 8x (30s each, 30s cooldown)
:: ============================================================

set "EXE=%~dp0AprNesAvalonia.exe"
set "ROM=%~dp0tools\benchmark\ny2011.nes"
set "TMPFILE=%TEMP%\aprnesava_bench.txt"
set JIT_SEC=10
set TEST_SEC=30
set COOL_SEC=30

echo ============================================================
echo   AprNesAvalonia Full Pipeline Benchmark
echo   ROM: ny2011.nes
...
echo.
echo ============================================================
echo   BENCHMARK RESULTS (AprNesAvalonia / .NET 10)
echo ============================================================
echo.
echo   Configuration:
echo     Runtime:      .NET 10 (TieredPGO)
